...
module.exports = {
    ...
    async execute(interaction) {
        const embed = new EmbedBuilder()
            ...
            .addFields("</play:1206281046891429888>", "```/play <songname> (Simply Plays A Song In The VC You Are In)```", true)
            ...
            .addFields(".stop", "```Simply Stops The Song```", true)
            ...
            .addFields("</ping:876100139498995792>", "```Simply Shows You The Latency```", true)
